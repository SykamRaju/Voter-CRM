...
st.set_page_config(page_title = 'Voter CRM Dashboard',
                    layout='wide',
...
# with Q1:
#     st.markdown("<h5 style='text-align: center; color: #5B9BD5;'>Local MLA Rating</h5>", unsafe_allow_html=True)

#with Q2:
#    st.markdown("<h5 style='text-align: center; color: #5B9BD5;'>Opp MLA Rating</h5>", unsafe_allow_html=True)

#with Q3:
#    st.markdown("<h5 style='text-align: center; color: #5B9BD5;'>Corporator/Village President Rating</h5>", unsafe_allow_html=True)
