...
class EditDistrict:
    ...
    def __init__(self,get_states: Callable[[str], bool],
        ...
        if states is not None:
            ...
            new_district_name = st.text_input("New name for District")
            ...
            if st.button('Edit District name'):
                # st.write(selected_district," ",new_district_name)
                # st.write(district_details)
                # st.write(districts)
                District_Id = district_details[selected_district]['District_Id']
                # st.write(District_Id)
                message = edit_district(selected_district,new_district_name,District_Id)
                st.success(message)
